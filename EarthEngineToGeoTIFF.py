...
def getNAIPImage(lon, lat, sze, filename, dateMin = '2017-01-01', dateMax = '2020-12-31', vmin = 0, vmax = 3500):
    '''    
...
def getPlanetSkySat(lon, lat, sze, filename, dateMin = '2016-06-01', dateMax = '2016-09-01', vmin = 0, vmax = 3500):
    '''    
    download an RGB image from the Sentinal S2 Surface Reflectance satellite, at the given coordinates
